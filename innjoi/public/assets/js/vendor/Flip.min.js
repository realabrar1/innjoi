...
!(function (t, e) {
  ...
  function ra(t, e, i) {
    return t && e.length && i.add(t(qa(e), i, new ut(e, 0, !0)), 0);
  }
      ...
      (d = e.alt[s] ? ua(e, t, s) : e.idLookup[s]),
        ...
        n
          ? ((p = {
            ...
            (u._flip = n.element._flip = tt ? tt.timeline : D))
          : d.isVisible &&
            (G.push({
              t: u,
              b: $(d, {
            ...
            (u._flip = tt ? tt.timeline : D));
    X &&
      (st[X] || aa(X)).forEach(function (e) {
        return (z[e] = function (t) {
          return G[t].a.props[e];
        });
      }),
      (G.finalStates = f = []),
      (m = function run() {
        for (da(G), ya(!0), l = 0; l < G.length; l++)
          (p = G[l]),
            (g = p.a),
            (y = p.b),
            !A || g.isDifferent(y) || p.entering
              ? ((u = p.t),
                !I ||
                  p.sd < 0 ||
                  !l ||
                ...
                y.isVisible && g.isVisible
                  ? (p.sd < 0
                      ? ((h = new pt(u, X, t.simple)),
                        ot(h, g, T, 0, 0, h),
                        (h.matrix = getGlobalMatrix(u, !1, !1, !0)),
                        (h.css = p.b.css),
                        (p.a = g = h),
                        P && (u.style.opacity = Z ? y.opacity : g.opacity),
                        O && q.push(u))
                      : 0 < p.sd &&
                        P &&
                  ...
                  : y.isVisible !== g.isVisible &&
                    (y.isVisible
                      ? g.isVisible ||
                        ...
                        G.splice(l--, 1),
                        S && I && ot(g, y, T, X))
                      : (g.isVisible && Y.push(g), G.splice(l--, 1))),
                T ||
        ...
        if (
          ...
          T
            ...
            : ((z.width = function (t) {
                return G[t].a.width + "px";
              }),
              (z.height = function (t) {
                return G[t].a.height + "px";
              }),
          ...
          (z.rotation = function (t) {
            return G[t].a.rotation + (N ? 360 * H(t, c[t], c) : 0);
          }),
          (z.skewX = function (t) {
            return G[t].a.skewX;
          }),
          ...
          P &&
            (z.opacity = function (t) {
              return G[t].sd < 0 ? 0 : 0 < G[t].sd ? G[t].a.opacity : "+=0";
            }),
          q.length)
        ) {
          ...
          z.stagger = function (t, e) {
            return O(~q.indexOf(e) ? c.indexOf(G[t].swap.t) : t, e, i);
          };
        }
        if (
        ...
        n &&
          ...
          D.call(function () {
            var t = D.time() >= o;
            t && !n && ga(G, !x), F && W(e, F, t ? "remove" : "add");
          });
      }),
      k &&
        (S = G.filter(function (t) {
          return !t.sd && !t.a.isVisible && t.b.isVisible;
        }).map(function (t) {
          return t.a.element;
        })),
      tt
        ? (S && (v = tt._abs).push.apply(v, ja(G, S)), tt._run.push(m))
        : (S && ka(ja(G, S)), m());
    var J = tt ? tt.timeline : D;
    return (
      (J.revert = function () {
        return lt(J, 1);
      }),
  ...
  var T,
    ...
    F = {},
    et = {},
    it = R("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"),
    nt = R(
      ...
      return (
        L || !m
          ...
          : ((h = (p = (function _getInverseGlobalMatrix(t) {
            ...
            (S = V(Math.atan2(h.b, h.a) * O)),
            (s = V(Math.atan2(h.c, h.d) * O + S) % 360),
            ...
            (d.skewX = s + "deg")),
        i
          ? ((b *= v !== E.width && E.width ? v / E.width : 1),
            (w *= x !== E.height && E.height ? x / E.height : 1),
            (d.scaleX = b),
            (d.scaleY = w))
          : ((v = P((v * b) / E.scaleX, 0)),
            (x = P((x * w) / E.scaleY, 0)),
        ...
        a &&
          ...
          i
            ...
            : ((a.width = v), (a.height = x))),
        a || d
      );
    },
    X = [],
    D = "width,height,overflowX,overflowY".split(","),
    lt = function _killFlip(t, e) {
          ...
          (a = g[n]),
            ...
            s
              ? ((l = i.isVisible || (!s.isVisible && r === i.element) ? i : s),
                ...
                jh(o.element !== i.element && a ? a : o, i, i.element),
                jh(a && a.element === s.element ? a : o, s, s.element),
                a && jh(a, s.element === a.element ? s : i, a.element))
              : (i ? (i.isDifferent(e) ? ih(e, i, r) : h.push(r)) : f.push(r),
                a && jh(a, i, a.element));
        for (n in p)
          u[n] || (d.push(p[n].element), y[n] && d.push(y[n].element));
        return {
          changed: c,
          unchanged: h,
          enter: f,
  ...
  var j,
    G =
      (((j = FlipAction.prototype).getStateById = function getStateById(t) {
        for (var e = this.states.length; e--; )
          if (this.states[e].idLookup[t]) return this.states[e];
      }),
      (j.kill = function kill() {
  ...
  var q,
    H =
          ...
          tt = this,
            ...
            this.actions.forEach(function (t) {
              ...
              a &&
                ...
                (i = e.compare(J.getState(a))).enter.length && n && n(i.enter),
      ...
      (q.kill = function kill() {
        (this._killed = 1), this.clear(), delete E[this.id];
      }),
      FlipBatch);
  ...
  var J =
    ...
    (Flip.batch = function batch(t) {
      return E[(t = t || "default")] || (E[t] = new H(t));
    }),
    (Flip.killFlipsOf = function killFlipsOf(t, e) {
      (t instanceof ut ? t.targets : T(t)).forEach(function (t) {
